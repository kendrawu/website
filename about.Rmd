...
Currently at Oxford, Kendra is designing, implementing, and evaluating a novel vaccination trial, which combines approaches from clinical trial methodology, infectious disease epidemiology, and applied public health that can be implemented in a resource-poor country effectively during an on-going epidemic. 

Kendra's focus has been on respiratory pathogens, and more recently Ebola virus, but she is interested in other pathogens as well. She is also involved in research in geriatric medicine.

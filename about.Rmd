...
Currently at Oxford, Kendra is designing, implementing, and evaluating a novel vaccination trial, which combines approaches from clinical trial methodology, infectious disease epidemiology, and applied public health, so that it can be implemented in a resource-poor country effectively during an on-going epidemic. 

Kendra's focus has been on emerging and re-emerging pathogens, including respiratory pathogens, and more recently filoviruses. She is also involved in research in geriatric medicine.
